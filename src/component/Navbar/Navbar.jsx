            ...
            <div className="container">
                <div className="row align-items-center">
                                        ...
                                        <g id="Logo-2" data-name="Logo" transform="translate(260 51)">
                                            <g id="Elements">
                                                <path id="Path_1429" data-name="Path 1429"
                                                      ...
                                                      transform="translate(-270.155 -115.396)" fill="#f29f05"></path>
                                                <path id="Path_1430" data-name="Path 1430"
                                                      ...
                                                      transform="translate(-264.176 -113.935)" fill="#fff"></path>
                                                <path id="Path_1431" data-name="Path 1431"
                                                      ...
                                                      transform="translate(-266.247 -108.544)" fill="#363636"></path>
                                                <path id="Path_1432" data-name="Path 1432"
                                                      d="M302.183,132.519a7.064,7.064,0,1,1-14.122,0Z"
                                                      transform="translate(-264.027 -108.446)" fill="#363636"></path>
                                                <path id="Path_1433" data-name="Path 1433"
                                                      ...
                                                      transform="translate(-271.815 -108.923)" fill="#f29f05"></path>
                    ...
                    <div className="col-lg-7">
                        <nav className="navbar">
                            <ul className="navbar-links">
                                {/* Convert these to <Link> if using react-router */}
                    ...
                    <div className="col-lg-3">
                        <div className="extras bag">
                            <button id="desktop-menu" className="menu-btn">
